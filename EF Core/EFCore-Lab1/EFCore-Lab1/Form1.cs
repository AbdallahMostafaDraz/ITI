...
namespace EFCore_Lab1
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Department_ComboBox.DataSource = EmpDept_COMBO.DataSource = allDepartments;
            Department_ComboBox.DisplayMember = EmpDept_COMBO.DisplayMember = "Name";
            Department_ComboBox.ValueMember = EmpDept_COMBO.ValueMember = "ID";
            DeptID_TXT.Text = DeptName_TXT.Text = DeptLocation_TXT.Text = "";
        }
        ...
        private void DeleteDept_BTN_Click(object sender, EventArgs e)
        {
            ...
            if (Department_ComboBox.Text != "")
            {
                var departmenttToDelete = _context.Departments.FirstOrDefault(e => e.Id == int.Parse(Department_ComboBox.SelectedValue!.ToString()!));
